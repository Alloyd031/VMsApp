...
namespace VMsApp
{
    public sealed partial class Preferences : WindowEx
    {
        ...
        public Preferences()
        {
            ...
            AppWindow.Resize(new SizeInt32(910, 790));
            this.CenterOnScreen();
        ...
        private void PreferencesTitleBar_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void PreferencesTitleBar_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void PreferencesTitleBar_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
